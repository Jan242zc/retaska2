...
final class PurchaseFactory
{
	...
	public static function createFromObject($object): Purchase
	{
		...
		return new Purchase($id, $object->customerName, $object->customerStreetAndNumber, $object->customerCity, $object->customerZip, $object->customerCountry, $object->email, $object->phone, $object->deliveryName, $object->deliveryPrice, $object->paymentName, $object->paymentPrice, $object->shipToOtherThanCustomerAdress, $object->purchaseStatus, $object->deliveryStreetAndNumber, $object->deliveryCity, $object->deliveryZip, $object->deliveryCountry, $object->note);
	}
